...
# Open video
video_path = '/home/ARAR/Downloads/headcount.avi'
...
# Define two lines for counting
DISPLAY_WIDTH = frame_width
DISPLAY_HEIGHT = frame_height

line1_y = int(DISPLAY_HEIGHT * 0.3)  # Line 1 (example: top)
line2_y = int(DISPLAY_HEIGHT * 0.7)  # Line 2 (example: bottom)
...
while cap.isOpened():
    ...
    for track in tracks:
        ...
        if track_id not in object_info:
            ...
            # Check if object crossed any line
            if (prev_cy <= line1_y and cy > line1_y) or (prev_cy >= line1_y and cy < line1_y):
                if 'line1' not in object_info[track_id]['